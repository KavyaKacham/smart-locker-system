...
function LockerIllustration() {
  ...
  return (
    <div style={{ position: "relative", width: 260, height: 300 }}>
      ...
      <div style={{
        position: "absolute", inset: "28px 18px 18px",
        borderRadius: "14px",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <a href="/forgot-password" style={{
              color: "#818cf8", fontSize: "0.84rem", textDecoration: "none", fontWeight: 500
            }}
          ...
          <p style={{
            ...
            fontSize: "0.85rem", marginTop: "18px"
          }}>
